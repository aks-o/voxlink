...
exports.createPerformanceRouter = createPerformanceRouter;
...
function createPerformanceRouter() {
    ...
    const performanceMonitor = performance_monitoring_middleware_1.PerformanceMonitoringService.getInstance();
    /**
    ...
    router.get('/slow-requests', (req, res) => {
        try {
            ...
            logger_1.logger.error('Failed to get slow requests', { error });
            res.status(500).json({
                success: false,
    ...
    router.get('/query-optimization', (req, res) => {
        try {
            ...
            logger_1.logger.error('Failed to get query optimization suggestions', { error });
            res.status(500).json({
                success: false,
    ...
    router.get('/trends', (req, res) => {
        try {
            ...
            logger_1.logger.error('Failed to get performance trends', { error });
            res.status(500).json({
                success: false,
