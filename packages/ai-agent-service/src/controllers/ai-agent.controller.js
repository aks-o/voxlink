...
class AIAgentController {
    async getAgents(req, res) {
        try {
            ...
            logger_1.logger.error('Error fetching AI agents:', error);
            res.status(500).json({
                success: false,
    ...
    async getAgent(req, res) {
        try {
            ...
            logger_1.logger.error('Error fetching AI agent:', error);
            res.status(500).json({
                success: false,
    ...
    async createAgent(req, res) {
        try {
            ...
            logger_1.logger.error('Error creating AI agent:', error);
            res.status(500).json({
                success: false,
    ...
    async updateAgent(req, res) {
        try {
            ...
            logger_1.logger.error('Error updating AI agent:', error);
            res.status(500).json({
                success: false,
    ...
    async deleteAgent(req, res) {
        try {
            ...
            logger_1.logger.error('Error deleting AI agent:', error);
            res.status(500).json({
                success: false,
    ...
    async toggleAgent(req, res) {
        try {
            ...
            logger_1.logger.error('Error toggling AI agent:', error);
            res.status(500).json({
                success: false,
    ...
    async getVoiceOptions(req, res) {
        try {
            ...
            logger_1.logger.error('Error fetching voice options:', error);
            res.status(500).json({
                success: false,
    ...
    async previewVoice(req, res) {
        try {
            ...
            logger_1.logger.error('Error generating voice preview:', error);
            res.status(500).json({
                success: false,
...
exports.aiAgentController = new AIAgentController();
