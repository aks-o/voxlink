...
exports.performancePresets = exports.performanceConfigs = exports.defaultPerformanceConfig = void 0;
 ...
 */
exports.performanceConfigs = {
    development: {
        ...exports.defaultPerformanceConfig,
        monitoring: {
            ...exports.defaultPerformanceConfig.monitoring,
            metricsInterval: 60000, // 1 minute in development
        },
        autoScaling: {
            ...exports.defaultPerformanceConfig.autoScaling,
            enabled: false, // Disable auto-scaling in development
        },
        cache: {
            ...exports.defaultPerformanceConfig.cache,
    ...
    staging: {
        ...
        cdn: {
            ...exports.defaultPerformanceConfig.cdn,
            enabled: true,
        },
    },
    production: {
...
function getPerformanceConfig() {
    ...
    switch (env) {
        case 'production':
            return exports.performanceConfigs.production;
        case 'staging':
            return exports.performanceConfigs.staging;
        case 'development':
        default:
            return exports.performanceConfigs.development;
    }
}
/**
